...
// дополниьельные элементы
let linksElement = document.createElement("div");
linksElement.className = "links";
linksElement.id = "links";
linksElement.innerHTML = `
    <a id="about-me-page" href="about.html">Обо мне</a>
    <a id="works-page" href="projects.html">Проекты</a>
    <a id="contacts-page" href="contacts.html">Контакты</a>`;

let menuElement = document.createElement("div");
menuElement.className = "menu";
menuElement.id = "menu";
menuElement.innerHTML = `
    <input class="checkbox" type="checkbox" id="checkbox-nav-bar" />
    ...
    <div class="menu-items">
        ...
        <li><a id="works-page" href="projects.html">Проекты</a></li>
        <li>
            <a id="contacts-page" href="contacts.html">Контакты</a>
        </li>
    </div>`;

let mobilePhoneCardNav = document.createElement("div");
mobilePhoneCardNav.className = "mobile-nav image-box-navigation";
mobilePhoneCardNav.innerHTML = `
    <button class="navigation-button" id="mobile-phone-navigation-left"><</button>
    <button class="navigation-button" id="mobile-phone-navigation-right">></button>`;

let screenshots1 = document.createElement("div");
screenshots1.id = "screenshots-1";
screenshots1.innerHTML = `
    <div class="bg-image screenshot" id="screenshot-main"></div>
    <div class="bg-image screenshot" id="screenshot-profile"></div>
    <div class="bg-image screenshot" id="screenshot-settings"></div>`;

let screenshots2 = document.createElement("div");
screenshots2.id = "screenshots-2";
screenshots2.innerHTML = `
    <div class="bg-image screenshot" id="screenshot-statistics-day"></div>
    <div class="bg-image screenshot" id="screenshot-statistics-week"></div>
    <div class="bg-image screenshot" id="screenshot-statistics-course"></div>`;
...
window.onload = function() {
    ...
    if (location.pathname.includes("index") || location.pathname.split("").pop() == "/") {
        ...
        let kasumiImages1 = [
            "https://i.ibb.co/C5PHd54/kasumi-Encryption.jpg",
            "https://i.ibb.co/njcKYJq/kasumi-Decryption.jpg",
        ];

        let kasumiImages2 = [
            "https://i.ibb.co/Bnrztbz/kasumi-Algorithm.jpg",
            "https://i.ibb.co/gt20RP4/kasumiFI.jpg",
            "https://i.ibb.co/cC00qZ2/kasumiFO.jpg",
            "https://i.ibb.co/q5r8PXn/kasumiFL.jpg",
        ];

        let kasumiImages1Small = [
            "https://i.ibb.co/rFMpjmq/kasumi-Encryption-small.jpg",
            "https://i.ibb.co/1bWVNFL/kasumi-Decryption-small.png",
        ];

        let kasumiImages2Small = [
            "https://i.ibb.co/JQ12ybH/kasumi-Algorithm-small.jpg",
        ...
        let proCreditImages = [
            "https://i.ibb.co/dfpgPhb/pro-Credit1.jpg",
        ...
        let proCreditImagesSmall = [
            "https://i.ibb.co/khp66W5/pro-Credit1-small.jpg",
        ...
        let basketballImages = [
            "https://i.ibb.co/BjfZZLs/basketball-Flight-Modeling1.jpg",
        ...
        let basketballImagesSmall = [
            "https://i.ibb.co/hVvGs7z/basketball-Flight-Modeling1-small.jpg",
        ...
        let studentsImages = [
            "https://i.ibb.co/7Cb90C8/students-Knowledge-Control1.jpg",
        ...
        let studentsImagesSmall = [
            "https://i.ibb.co/WkC5YZG/students-Knowledge-Control1-small.jpg",
        ...
        document.getElementById("interactive-layout-button-1").onclick = function() {
            window.location.href =
                "https://www.figma.com/proto/1l01NZ1BpN7Q5N1txMbLT4/PerfectPosture?page-id=0%3A1&node-id=202-344&viewport=-269%2C450%2C0.07&scaling=scale-down&starting-point-node-id=202%3A344";
        };
        ...
        function boxImageChanger(clickCounter, imageBox, imagesArray, smallImagesArray) {
            imageBox.style.backgroundImage =
                ...
                `url(${
								smallImagesArray[
									smallImagesArray.length - 1 + (clickCounter % smallImagesArray.length)
								]
						  })` :
                document.body.clientWidth >= 1024 ?
